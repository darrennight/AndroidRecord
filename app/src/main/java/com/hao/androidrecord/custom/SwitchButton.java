...
public class SwitchButton extends View {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        TypedArray typedValue = context.obtainStyledAttributes(attrs, R.styleable.SwitchButtonView);
        mOpenBackground = typedValue.getColor(R.styleable.SwitchButtonView_sb_openBackground, DEFAULT_OPEN_BACKGROUND);
        mCloseBackground = typedValue.getColor(R.styleable.SwitchButtonView_sb_closeBackground, DEFAULT_CLOSE_BACKGROUND);
        mCircleColor = typedValue.getColor(R.styleable.SwitchButtonView_sb_circleColor, DEFAULT_CIRCLE_COLOR);
        mCircleRadius = typedValue.getDimension(R.styleable.SwitchButtonView_sb_circleRadius, DEFAULT_CIRCLE_RADIUS);
        isOpen = typedValue.getInt(R.styleable.SwitchButtonView_sb_status, 0) != 0;
        mInterpolator = getInterpolator(typedValue.getInt(R.styleable.SwitchButtonView_sb_interpolator, -1));
        typedValue.recycle();
