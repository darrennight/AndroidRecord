package com.hao.androidrecord.custom.ninegride;
            ...
            if (showStyle == STYLE_CUSTOM) {
                ...
                switch (getChildCount()) {
                    case 1:
                        ...
                        height = widthSize * img1.getDrawable().getMinimumHeight()/ img1.getDrawable().getMinimumWidth() ;
                        Log.e("=========image",""+height);
                        break;
                    case 2:
