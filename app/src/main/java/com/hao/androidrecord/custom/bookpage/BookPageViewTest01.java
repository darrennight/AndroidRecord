 ...
 * 使用版demo1
 */
public class BookPageViewTest01 extends RelativeLayout {
    ...
    public BookPageViewTest01(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }
...
//        pathCPaint.setStyle(Paint.Style.STROKE);
        ...
        testPaint.setAntiAlias(true);//设置抗锯齿
        testPaint.setColor(Color.WHITE);
        testPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    ...
    protected void dispatchDraw(Canvas canvas) {
       ...
       /* if(a.x==-1 && a.y==-1){
            ...
            if(f.x==viewWidth && f.y==0){
                canvas.drawPath(getPathAFromTopRight(),paintClip);
            }else if(f.x==viewWidth && f.y==viewHeight){
                canvas.drawPath(getPathAFromLowerRight(),paintClip);
            }
        }*/
...
//            canvas.drawPaint(pathAPaint);
            ...
            if(f.x==viewWidth && f.y==0){
                ...
                canvas.clipPath(getPathAFromLowerRight());
            }
