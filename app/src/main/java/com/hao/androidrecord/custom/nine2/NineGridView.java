package com.hao.androidrecord.custom.nine2;
...
public class NineGridView extends CardView {
    ...
    public NineGridView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //取消阴影效果
        setCardElevation(0f);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGridViewNew, defStyleAttr,
                R.style.CardView);
        mSpace = typedArray.getDimensionPixelOffset(R.styleable.NineGridViewNew_pictureSpace, 0);
        int bigPictureMaxHeight = typedArray.getDimensionPixelOffset(R.styleable.NineGridViewNew_bigPictureMaxHeight, 500);
        typedArray.recycle();
