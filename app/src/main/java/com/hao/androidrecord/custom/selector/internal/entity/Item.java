...
public class Item implements Parcelable {
    ...
    public static Item valueOf(Cursor cursor) {
        ...
        item.width = cursor.getInt(cursor.getColumnIndex(MediaStore.MediaColumns.WIDTH));
        item.height = cursor.getInt(cursor.getColumnIndex(MediaStore.MediaColumns.HEIGHT));
        return item;
    }
