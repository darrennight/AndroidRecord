package com.hao.androidrecord.custom.selector.internal.loader;
...
public class AlbumMediaLoader extends CursorLoader {
     ...
     * 视频过滤条件
     */
    private static final String SELECTION_ALL_FOR_SINGLE_MEDIA_TYPE_test =
            MediaStore.Files.FileColumns.MEDIA_TYPE + "=?"
                    + " AND " + MediaStore.MediaColumns.SIZE + ">0"
                    + " AND " + MediaStore.Video.VideoColumns.DURATION + ">=5000";
...
//                selection = SELECTION_ALL_FOR_SINGLE_MEDIA_TYPE;
                selection = SELECTION_ALL_FOR_SINGLE_MEDIA_TYPE_test;
                selectionArgs =
                        getSelectionArgsForSingleMediaType(
