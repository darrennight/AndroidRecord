package com.hao.androidrecord.util.barlib.bar;
...
import com.hao.androidrecord.util.barlib.utils.StatusBarColorUtils;
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity, boolean isLightStatusBar){
        Window window = activity.getWindow();
