package com.hao.androidrecord.calendar.activity.lib02;
...
import com.hao.androidrecord.calendar.activity.lib02.custom.CustomActivity;
import com.hao.androidrecord.calendar.activity.lib02.full.FullActivity;
import com.hao.androidrecord.calendar.activity.lib02.mix.MixActivity;
import com.hao.androidrecord.calendar.activity.lib02.multi.MultiActivity;
import com.hao.androidrecord.calendar.activity.lib02.range.RangeActivity;
import com.hao.androidrecord.calendar.lib02.Calendar;
import com.hao.androidrecord.calendar.lib02.CalendarLayout;
import com.hao.androidrecord.calendar.lib02.CalendarView;
import com.hao.androidrecord.calendar.lib02.TrunkBranchAnnals;
...
public class CalendarLib02Activity extends BaseActivity implements
    ...
    protected int getLayoutId() {
        return R.layout.activity_calendar_lib02;
    }
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMoreDialog == null) {
                    mMoreDialog = new AlertDialog.Builder(CalendarLib02Activity.this)
                            .setTitle(R.string.list_dialog_title)
                            .setItems(R.array.list_dialog_items, CalendarLib02Activity.this)
                            .create();
                }
                mMoreDialog.show();
            }
...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
                            ...
                            case 6:
                                ...
                                new AlertDialog.Builder(CalendarLib02Activity.this)
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(CalendarLib02Activity.this)
