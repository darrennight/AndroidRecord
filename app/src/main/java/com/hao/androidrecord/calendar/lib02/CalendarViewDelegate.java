 ...
 */
package com.hao.androidrecord.calendar.lib02;
...
final class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_week_lib01_text_size,
        ...
        mWeekTextColor = array.getColor(R.styleable.CalendarView_week_lib01_text_color, 0xFF333333);
