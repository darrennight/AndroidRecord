...
public class CalendarViewPagerActivity extends BaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, CalendarViewPagerActivity.class));
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_calendar_view_pager;
    }
