package com.hao.androidrecord.activity.scrollable07.adapter;
...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder> {
    ...
    public GroupAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_group, viewGroup, false);
