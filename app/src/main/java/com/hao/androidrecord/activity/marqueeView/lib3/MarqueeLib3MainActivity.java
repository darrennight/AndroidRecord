...
//https://github.com/jiaoyaning/MarqueeView
public class MarqueeLib3MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_marquee_lib3);
        initView();
    }
