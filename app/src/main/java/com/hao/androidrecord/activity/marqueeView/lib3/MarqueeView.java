package com.hao.androidrecord.activity.marqueeView.lib3;
...
public class MarqueeView extends HorizontalScrollView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MarqueeViewLib3);
        textColor = typedArray.getColor(R.styleable.MarqueeViewLib3_mv3textColor, textColor);
        if (typedArray.hasValue(R.styleable.MarqueeViewLib3_mv3textSize)) {
            textSize = (int) typedArray.getDimension(R.styleable.MarqueeViewLib3_mv3textSize, textSize);
            textSize = px2sp(context, textSize);
        }

        if (typedArray.hasValue(R.styleable.MarqueeViewLib3_mv3spacing)) {
            spacing = (int) typedArray.getDimension(R.styleable.MarqueeViewLib3_mv3spacing, spacing);
        }

        if (typedArray.hasValue(R.styleable.MarqueeViewLib3_mv3speed)) {
            speed = (int) typedArray.getInteger(R.styleable.MarqueeViewLib3_mv3speed, 2);
        }
    }
