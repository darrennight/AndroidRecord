...
import com.hao.androidrecord.custom.ninegride.NineGridView;
 ...
 * @date : 2017/4/20 .
 * @description : .
 * https://github.com/MrWhhh/NineGridView
 */
public class CustomGirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ListAdapter(this,list, NineGridView.STYLE_CUSTOM);
