...
public class SlidingTab extends View {
    ...
    public void dealAttrs(Context context, AttributeSet attrs) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.SlidingTab_tabTextSize, (int) DEFAULT_TEXT_SIZE);
        mRadius = ta.getDimensionPixelSize(R.styleable.SlidingTab_tab_radius, DEFAULT_RADIUS);
