package com.hao.androidrecord.activity.scrollable03.fragment;
...
import com.hao.androidrecord.activity.scrollable03.adapter.PagerListAdapter;
import com.hao.androidrecord.activity.scrollable03.weight.InnerRecyclerView1;
...
public class PagerFragment extends Fragment implements InnerRecyclerView1.NeedIntercepectListener {
    ...
    public void needIntercepect(boolean needIntercepect) {
        ((MainActivityScrollable03)getActivity()).adjustIntercept(!needIntercepect);
    }
}
