package com.hao.androidrecord.activity.sheet.adapter;
...
public class StringAdapter extends RecyclerView.Adapter<StringAdapter.VH> {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pinned_layout, parent, false);
