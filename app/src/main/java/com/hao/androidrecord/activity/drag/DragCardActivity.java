package com.hao.androidrecord.activity.drag;
...
//https://github.com/MZCretin/DragDemo
...
//        Log.e(TAG, "位置" + index);
    ...
    class FlowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if ( viewType == 0 ) {
                //正文内容类型
                return new MyHolder(View.inflate(DragCardActivity.this, R.layout.flow_item_drag, null));
            } else {
                //占位符类型
                return new MyHolderDivider(View.inflate(DragCardActivity.this, R.layout.flow_divider, null));
            }
        }
