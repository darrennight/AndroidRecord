package com.hao.androidrecord.activity.RichEdit.model
...
import com.hao.androidrecord.activity.RichEdit.contract.IMVVMView
import com.hao.androidrecord.activity.RichEdit.span.CustomClickAtUserSpan
import com.hao.androidrecord.activity.RichEdit.span.CustomClickTopicSpan
import com.hao.androidrecord.activity.RichEdit.span.CustomLinkSpan
import com.hao.androidrecord.activity.RichEdit.utils.JumpUtil
    ...
    fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent) {
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                ...
                REQUEST_TOPIC_CODE_INPUT -> topicResultByEnter.set(data.getSerializableExtra(
                    TopicListActivity.DATA) as TopicModel)
