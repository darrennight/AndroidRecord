...
import com.hao.androidrecord.activity.LuckyWheel.view.WheelView;
...
public class LuckyWheel extends FrameLayout implements View.OnTouchListener, OnRotationListener {
    ...
    public void applyAttribute(AttributeSet attrs) {
        ...
        try {
            int backgroundColor = typedArray.getColor(R.styleable.LuckyWheel_wheel_background_color, Color.GREEN);
