package com.hao.androidrecord.activity.marqueeView.lib1.ui;
...
import com.hao.androidrecord.activity.marqueeView.lib1.MarqueeFactory;
import com.hao.androidrecord.activity.marqueeView.lib1.MarqueeView;
import com.hao.androidrecord.activity.marqueeView.lib1.SimpleMF;
import com.hao.androidrecord.activity.marqueeView.lib1.SimpleMarqueeView;
import com.hao.androidrecord.activity.marqueeView.lib1.util.OnItemClickListener;
...
public class MarqueeMainActivity extends AppCompatActivity {
    ...
    private void initMarqueeView1() {
        SimpleMF<String> marqueeFactory = new SimpleMF(MarqueeMainActivity.this);
    ...
    private void initMarqueeView2() {
        SimpleMF<String> marqueeFactory2 = new SimpleMF(MarqueeMainActivity.this);
    ...
    private void initMarqueeView3() {
        SimpleMF<Spanned> marqueeFactory3 = new SimpleMF<>(MarqueeMainActivity.this);
        ...
        marqueeView3.setOnItemClickListener(new OnItemClickListener<TextView, Spanned>() {
            ...
            public void onItemClickListener(TextView mView, Spanned mData, int mPosition) {
                Toast.makeText(MarqueeMainActivity.this, String.format("mPosition:%s,mData:%s,mView:%s,.", mPosition, mData, mView), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initMarqueeView4() {
        ...
        MarqueeFactory<RelativeLayout, ComplexItemEntity> marqueeFactory = new ComplexViewMF(MarqueeMainActivity.this);
