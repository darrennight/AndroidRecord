...
import com.hao.androidrecord.custom.nine2.NetImageUtil
import kotlinx.android.synthetic.main.item_nine_content.view.*
...
class MainAdapter(var data: List<String>) : RecyclerView.Adapter<MainAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_nine_content, parent, false)
