...
import com.hao.androidrecord.databinding.ActivityAboutPhysicsBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityAboutPhysicsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gimbal = Gimbal(this)
        gimbal.lock()
        binding = ActivityAboutPhysicsBinding.inflate(layoutInflater)
