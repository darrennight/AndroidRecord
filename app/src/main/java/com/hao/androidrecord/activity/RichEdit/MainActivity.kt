...
import com.hao.androidrecord.activity.RichEdit.utils.ScreenUtils
...
import kotlinx.android.synthetic.main.activity_main_rich.*

/**
 * https://github.com/CarGuo/GSYRickText
 * //换行的标签删除时会崩溃 需要使用源码然后解决
 *
 * 另外一个
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_rich)
        initView()
    }
