...
//
    ...
    init {
        ...
        textColor = ta.getColor(R.styleable.SeparatedEditText_pay_textColor, ContextCompat.getColor(getContext(), R.color.lightGrey))
        ...
        errorColor = ta.getColor(R.styleable.SeparatedEditText_payerrorColor, ContextCompat.getColor(getContext(), R.color.errorColor))
        ta.recycle()
        init()
    }
}
