...
class ExpandableCardView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet) {
        ...
        title = typedArray.getString(R.styleable.ExpandableCardView_ex_card_title)
        iconDrawable = typedArray.getDrawable(R.styleable.ExpandableCardView_ex_card_icon)
