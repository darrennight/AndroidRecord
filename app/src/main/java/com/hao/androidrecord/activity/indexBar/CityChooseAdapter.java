 ...
 *
 */
public class CityChooseAdapter extends BaseAdapter implements SectionIndexer {

	private Context mContext = null;
	private List<CountryCode> mList = null;
	public CityChooseAdapter(Context context, List<CountryCode> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.city_choose_item, parent, false);
			holder.mFirstLetter = (TextView) convertView.findViewById(R.id.tv_city_first_letter);
			holder.mProvinceName = (TextView) convertView.findViewById(R.id.tv_city_name);
